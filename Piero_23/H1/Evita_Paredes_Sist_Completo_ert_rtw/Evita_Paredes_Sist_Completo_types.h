 ...
 *
 * File: Evita_Paredes_Sist_Completo_types.h
 *
...
#ifndef RTW_HEADER_Evita_Paredes_Sist_Completo_types_h_
#define RTW_HEADER_Evita_Paredes_Sist_Completo_types_h_
#include "MW_SVD.h"
#include "rtwtypes.h"

/* Custom Type definition for MATLABSystem: '<S5>/Atras_izq' */
#include "MW_SVD.h"
...
typedef struct P_Evita_Paredes_Sist_Completo_T_ P_Evita_Paredes_Sist_Completo_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_Evita_Paredes_Sist_Co_T RT_MODEL_Evita_Paredes_Sist_C_T;

#endif                     /* RTW_HEADER_Evita_Paredes_Sist_Completo_types_h_ */
