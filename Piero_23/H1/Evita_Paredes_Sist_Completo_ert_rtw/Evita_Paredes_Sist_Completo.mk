###########################################################################
## Makefile generated for component 'Evita_Paredes_Sist_Completo'. 
## 
## Makefile     : Evita_Paredes_Sist_Completo.mk
## Generated on : Sun Nov 12 16:46:27 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Evita_Paredes_Sist_Completo.elf
...
PRODUCT_NAME              = Evita_Paredes_Sist_Completo
MAKEFILE                  = Evita_Paredes_Sist_Completo.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Evita_Paredes_Sist_Completo.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/target/shared/svd/common/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(START_DIR)/Evita_Paredes_Sist_Completo_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=5 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=62411 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=4 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_CONFIG_SERIAL0_=SERIAL_8N1 -D_RTT_CONFIG_SERIAL1_=SERIAL_8N1 -D_RTT_CONFIG_SERIAL2_=SERIAL_8N1 -D_RTT_CONFIG_SERIAL3_=SERIAL_8N1 -D_RTT_ANALOG_REF_=0 -D_RTT_PWM_BLOCKS_
...
DEFINES_STANDARD = -DMODEL=Evita_Paredes_Sist_Completo -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_arduino_digitalio.o MW_PWM.o MW_PWMDriver.o Evita_Paredes_Sist_Completo.o Evita_Paredes_Sist_Completo_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/Evita_Paredes_Sist_Completo_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Evita_Paredes_Sist_Completo_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Evita_Paredes_Sist_Completo_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Evita_Paredes_Sist_Completo.o : $(START_DIR)/Evita_Paredes_Sist_Completo_ert_rtw/Evita_Paredes_Sist_Completo.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Evita_Paredes_Sist_Completo_data.o : $(START_DIR)/Evita_Paredes_Sist_Completo_ert_rtw/Evita_Paredes_Sist_Completo_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Evita_Paredes_Sist_Completo_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
