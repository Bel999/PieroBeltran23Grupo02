...
#ifndef RTW_HEADER_Toma_De_Datos_h_
#define RTW_HEADER_Toma_De_Datos_h_
#ifndef Toma_De_Datos_COMMON_INCLUDES_
#define Toma_De_Datos_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* Toma_De_Datos_COMMON_INCLUDES_ */

#include "Toma_De_Datos_types.h"
#include <math.h>
...
typedef struct {
  ...
  codertarget_arduinobase_inter_T obj_i;/* '<S3>/Encoder' */
  codertarget_arduinobase_int_m_T obj_o;/* '<S4>/Atras_izq' */
  codertarget_arduinobase_int_m_T obj_g;/* '<S4>/Atras_der' */
  codertarget_arduinobase_int_m_T obj_e;/* '<S4>/Adelante_izq' */
  codertarget_arduinobase_int_m_T obj_c;/* '<S4>/Adelante_der' */
  codertarget_arduinobase_block_T obj_oq;/* '<S4>/Digital Output1' */
  codertarget_arduinobase_block_T obj_gs;/* '<S4>/Digital Output' */
...
struct tag_RTM_Toma_De_Datos_T {
...
extern P_Toma_De_Datos_T Toma_De_Datos_P;

/* Block signals (default storage) */
extern B_Toma_De_Datos_T Toma_De_Datos_B;

/* Block states (default storage) */
extern DW_Toma_De_Datos_T Toma_De_Datos_DW;

/* Model entry point functions */
extern void Toma_De_Datos_initialize(void);
extern void Toma_De_Datos_step(void);
extern void Toma_De_Datos_terminate(void);

/* Real-time Model object */
extern RT_MODEL_Toma_De_Datos_T *const Toma_De_Datos_M;
 ...
 *
 * '<Root>' : 'Toma_De_Datos'
 * '<S1>'   : 'Toma_De_Datos/Signal Editor'
 * '<S2>'   : 'Toma_De_Datos/Subsystem Reference'
 * '<S3>'   : 'Toma_De_Datos/Subsystem Reference/Subsystem Reference'
 * '<S4>'   : 'Toma_De_Datos/Subsystem Reference/Subsystem Reference4'
 * '<S5>'   : 'Toma_De_Datos/Subsystem Reference/Subsystem Reference4/Compare To Zero'
 * '<S6>'   : 'Toma_De_Datos/Subsystem Reference/Subsystem Reference4/Compare To Zero1'
 */
#endif                                 /* RTW_HEADER_Toma_De_Datos_h_ */
