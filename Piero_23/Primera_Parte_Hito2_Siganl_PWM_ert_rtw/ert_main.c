...
void rt_OneStep(void)
{
   ...
   */
  Primera_Parte_Hito2_Siganl_PWM_SetEventsForThisBaseStep(eventFlags);
  ...
  currentTime = (extmodeSimulationTime_T)
    ...
    ;
  Primera_Parte_Hito2_Siganl_PWM_step0();
  ...
  if (need2runFlags[2]) {
    ...
    switch (2)
    {
     case 2 :
      currentTime = (extmodeSimulationTime_T)
        ((Primera_Parte_Hito2_Siganl_P_M->Timing.clockTick2 * 10) + 0)
        ;
      Primera_Parte_Hito2_Siganl_PWM_step2();
