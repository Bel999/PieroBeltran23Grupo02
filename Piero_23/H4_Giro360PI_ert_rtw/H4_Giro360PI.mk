###########################################################################
## Makefile generated for component 'H4_Giro360PI'. 
## 
## Makefile     : H4_Giro360PI.mk
## Generated on : Thu Dec 21 16:29:24 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/H4_Giro360PI.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/H4_Giro360PI.elf
...
DEFINES_STANDARD = -DMODEL=H4_Giro360PI -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_ArduinoEncoder.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_arduino_digitalio.o H4_Giro360PI.o H4_Giro360PI_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/H4_Giro360PI_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/H4_Giro360PI_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/H4_Giro360PI_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
H4_Giro360PI.o : $(START_DIR)/H4_Giro360PI_ert_rtw/H4_Giro360PI.c
	$(CC) $(CFLAGS) -o "$@" "$<"


H4_Giro360PI_data.o : $(START_DIR)/H4_Giro360PI_ert_rtw/H4_Giro360PI_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/H4_Giro360PI_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/H4_Giro360PI_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/H4_Giro360PI_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/H4_Giro360PI_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
