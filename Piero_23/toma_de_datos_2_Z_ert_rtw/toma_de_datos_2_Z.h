...
#ifndef RTW_HEADER_toma_de_datos_2_Z_h_
#define RTW_HEADER_toma_de_datos_2_Z_h_
#ifndef toma_de_datos_2_Z_COMMON_INCLUDES_
#define toma_de_datos_2_Z_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* toma_de_datos_2_Z_COMMON_INCLUDES_ */

#include "toma_de_datos_2_Z_types.h"
#include <math.h>
...
typedef struct {
  ...
  real_T Signal2;                      /* '<S1>/From Workspace' */
...
} B_toma_de_datos_2_Z_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  codertarget_arduinobase_int_a_T obj; /* '<S3>/Encoder1' */
  codertarget_arduinobase_int_a_T obj_p;/* '<S3>/Encoder' */
  codertarget_arduinobase_inter_T obj_n;/* '<Root>/Analog Input' */
  codertarget_arduinobase_in_ah_T obj_m;/* '<S4>/Atras_izq' */
  codertarget_arduinobase_in_ah_T obj_l;/* '<S4>/Atras_der' */
  codertarget_arduinobase_in_ah_T obj_c;/* '<S4>/Adelante_izq' */
  codertarget_arduinobase_in_ah_T obj_k;/* '<S4>/Adelante_der' */
...
} DW_toma_de_datos_2_Z_T;

/* Parameters (default storage) */
struct P_toma_de_datos_2_Z_T_ {
...
struct tag_RTM_toma_de_datos_2_Z_T {
...
extern P_toma_de_datos_2_Z_T toma_de_datos_2_Z_P;

/* Block signals (default storage) */
extern B_toma_de_datos_2_Z_T toma_de_datos_2_Z_B;

/* Block states (default storage) */
extern DW_toma_de_datos_2_Z_T toma_de_datos_2_Z_DW;

/* Model entry point functions */
extern void toma_de_datos_2_Z_initialize(void);
extern void toma_de_datos_2_Z_step(void);
extern void toma_de_datos_2_Z_terminate(void);

/* Real-time Model object */
extern RT_MODEL_toma_de_datos_2_Z_T *const toma_de_datos_2_Z_M;
 ...
 *
 * Block '<S1>/fromWS_Signal 1' : Unused code path elimination
 ...
 *
 * '<Root>' : 'toma_de_datos_2_Z'
 * '<S1>'   : 'toma_de_datos_2_Z/Signal Editor'
 * '<S2>'   : 'toma_de_datos_2_Z/Subsystem Reference'
 * '<S3>'   : 'toma_de_datos_2_Z/Subsystem Reference/Subsystem Reference'
 * '<S4>'   : 'toma_de_datos_2_Z/Subsystem Reference/Subsystem Reference4'
 * '<S5>'   : 'toma_de_datos_2_Z/Subsystem Reference/Subsystem Reference4/Compare To Zero'
 * '<S6>'   : 'toma_de_datos_2_Z/Subsystem Reference/Subsystem Reference4/Compare To Zero1'
 */
#endif                                 /* RTW_HEADER_toma_de_datos_2_Z_h_ */
