...
{
  {
    ...
    /* FromWorkspace: '<S1>/fromWS_Signal 1' */
    {
      real_T *pDataValues = (real_T *)
        Toma_De_Datos_grafica_DW.fromWS_Signal1_PWORK.DataPtr;
      real_T *pTimeValues = (real_T *)
        Toma_De_Datos_grafica_DW.fromWS_Signal1_PWORK.TimePtr;
      int_T currTimeIndex =
        Toma_De_Datos_grafica_DW.fromWS_Signal1_IWORK.PrevIndex;
      real_T t = Toma_De_Datos_grafica_M->Timing.t[0];
      if (t > pTimeValues[6]) {
        Toma_De_Datos_grafica_B.Signal1 = 0.0;
      } else {
        /* Get index */
        if (t <= pTimeValues[0]) {
          currTimeIndex = 0;
        ...
        Toma_De_Datos_grafica_DW.fromWS_Signal1_IWORK.PrevIndex = currTimeIndex;
        ...
        /* Post output */
        {
          ...
          if (t1 == t2) {
            if (t < t1) {
              Toma_De_Datos_grafica_B.Signal1 = pDataValues[currTimeIndex];
            } else {
              Toma_De_Datos_grafica_B.Signal1 = pDataValues[currTimeIndex + 1];
            }
          } else {
            ...
            Toma_De_Datos_grafica_B.Signal1 = (real_T) rtInterpolate(d1, d2, f1,
              f2);
            pDataValues += 7;
          }
        }
    ...
    if (Toma_De_Datos_grafica_DW.obj_p.SampleTime !=
        Toma_De_Datos_grafica_P.Encoder_SampleTime) {
      Toma_De_Datos_grafica_DW.obj_p.SampleTime =
        Toma_De_Datos_grafica_P.Encoder_SampleTime;
    }

    if (Toma_De_Datos_grafica_DW.obj_p.TunablePropsChanged) {
      Toma_De_Datos_grafica_DW.obj_p.TunablePropsChanged = false;
    }

    MW_EncoderRead(Toma_De_Datos_grafica_DW.obj_p.Index, &rtb_Encoder_0);
    ...
    MW_EncoderRead(Toma_De_Datos_grafica_DW.obj.Index, &rtb_Encoder1_0);
     ...
     *  MATLABSystem: '<S3>/Encoder1'
     */
    Toma_De_Datos_grafica_B.Gain[0] = Gain_tmp * (real_T)rtb_Encoder_0;
    Toma_De_Datos_grafica_B.Gain[1] = Gain_tmp * (real_T)rtb_Encoder1_0;
    ...
    Toma_De_Datos_grafica_B.TmpSignalConversionAt_asyncqueu[0] =
      Toma_De_Datos_grafica_B.Signal1;
    ...
    Gain_tmp = floor(Toma_De_Datos_grafica_B.Signal1);
    ...
    Toma_De_Datos_grafica_DW.obj_k.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_GetHandle
      (12UL);
    ...
    /* MATLABSystem: '<S4>/Adelante_der' */
    MW_PWM_SetDutyCycle
      (Toma_De_Datos_grafica_DW.obj_k.PWMDriverObj.MW_PWM_HANDLE, (real_T)y);

    /* MATLABSystem: '<S4>/Adelante_izq' */
    Toma_De_Datos_grafica_DW.obj_c.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_GetHandle
      (9UL);

    /* Saturate: '<S4>/Saturation4' */
    if (rtb_DataTypeConversion_idx_0 >
        Toma_De_Datos_grafica_P.Saturation4_UpperSat) {
      y = Toma_De_Datos_grafica_P.Saturation4_UpperSat;
    } else if (rtb_DataTypeConversion_idx_0 <
               Toma_De_Datos_grafica_P.Saturation4_LowerSat) {
      y = Toma_De_Datos_grafica_P.Saturation4_LowerSat;
    } else {
    ...
    /* MATLABSystem: '<S4>/Adelante_izq' */
    MW_PWM_SetDutyCycle
      (Toma_De_Datos_grafica_DW.obj_c.PWMDriverObj.MW_PWM_HANDLE, (real_T)y);

    /* MATLABSystem: '<S4>/Atras_der' */
    Toma_De_Datos_grafica_DW.obj_l.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_GetHandle
      (11UL);
    ...
    /* MATLABSystem: '<S4>/Atras_der' */
    MW_PWM_SetDutyCycle
      (Toma_De_Datos_grafica_DW.obj_l.PWMDriverObj.MW_PWM_HANDLE, (real_T)y);

    /* MATLABSystem: '<S4>/Atras_izq' */
    Toma_De_Datos_grafica_DW.obj_m.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_GetHandle
      (10UL);

    /* Saturate: '<S4>/Saturation5' */
    if (rtb_DataTypeConversion_idx_0 >
        Toma_De_Datos_grafica_P.Saturation5_UpperSat) {
      y = Toma_De_Datos_grafica_P.Saturation5_UpperSat;
    } else if (rtb_DataTypeConversion_idx_0 <
               Toma_De_Datos_grafica_P.Saturation5_LowerSat) {
      y = Toma_De_Datos_grafica_P.Saturation5_LowerSat;
    } else {
      y = rtb_DataTypeConversion_idx_0;
    }
    ...
    /* MATLABSystem: '<S4>/Atras_izq' */
    MW_PWM_SetDutyCycle
      (Toma_De_Datos_grafica_DW.obj_m.PWMDriverObj.MW_PWM_HANDLE, (real_T)y);
    ...
    writeDigitalPin(13, (uint8_T)(rtb_DataTypeConversion_idx_1 !=
      Toma_De_Datos_grafica_P.Constant_Value_h));
  }
...
void Toma_De_Datos_grafica_initialize(void)
{
  ...
  Toma_De_Datos_grafica_M->Timing.stepSize0 = 0.1;

  /* External mode info */
  Toma_De_Datos_grafica_M->Sizes.checksums[0] = (733787327U);
  Toma_De_Datos_grafica_M->Sizes.checksums[1] = (2629912077U);
  Toma_De_Datos_grafica_M->Sizes.checksums[2] = (3018163913U);
  Toma_De_Datos_grafica_M->Sizes.checksums[3] = (3503909850U);
  ...
  /* Start for FromWorkspace: '<S1>/fromWS_Signal 1' */
  {
    ...
    Toma_De_Datos_grafica_DW.fromWS_Signal1_PWORK.TimePtr = (void *)
      pTimeValues0;
    Toma_De_Datos_grafica_DW.fromWS_Signal1_PWORK.DataPtr = (void *)
      pDataValues0;
    Toma_De_Datos_grafica_DW.fromWS_Signal1_IWORK.PrevIndex = 0;
  }
  ...
  /* Start for MATLABSystem: '<S4>/Adelante_der' */
  Toma_De_Datos_grafica_DW.obj_k.matlabCodegenIsDeleted = false;
  Toma_De_Datos_grafica_DW.obj_k.isInitialized = 1L;
  Toma_De_Datos_grafica_DW.obj_k.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_Open(12UL,
    0.0, 0.0);
  Toma_De_Datos_grafica_DW.obj_k.isSetupComplete = true;

  /* Start for MATLABSystem: '<S4>/Adelante_izq' */
  Toma_De_Datos_grafica_DW.obj_c.matlabCodegenIsDeleted = false;
  Toma_De_Datos_grafica_DW.obj_c.isInitialized = 1L;
  Toma_De_Datos_grafica_DW.obj_c.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_Open(9UL,
    0.0, 0.0);
  Toma_De_Datos_grafica_DW.obj_c.isSetupComplete = true;

  /* Start for MATLABSystem: '<S4>/Atras_der' */
  Toma_De_Datos_grafica_DW.obj_l.matlabCodegenIsDeleted = false;
  Toma_De_Datos_grafica_DW.obj_l.isInitialized = 1L;
  Toma_De_Datos_grafica_DW.obj_l.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_Open(11UL,
    0.0, 0.0);
  Toma_De_Datos_grafica_DW.obj_l.isSetupComplete = true;

  /* Start for MATLABSystem: '<S4>/Atras_izq' */
  Toma_De_Datos_grafica_DW.obj_m.matlabCodegenIsDeleted = false;
  Toma_De_Datos_grafica_DW.obj_m.isInitialized = 1L;
  Toma_De_Datos_grafica_DW.obj_m.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_Open(10UL,
    0.0, 0.0);
  Toma_De_Datos_grafica_DW.obj_m.isSetupComplete = true;

  /* Start for MATLABSystem: '<S4>/Digital Output' */
  Toma_De_Datos_grafica_DW.obj_mx.matlabCodegenIsDeleted = false;
  Toma_De_Datos_grafica_DW.obj_mx.isInitialized = 1L;
  digitalIOSetup(8, 1);
  Toma_De_Datos_grafica_DW.obj_mx.isSetupComplete = true;

  /* Start for MATLABSystem: '<S4>/Digital Output1' */
  Toma_De_Datos_grafica_DW.obj_o.matlabCodegenIsDeleted = false;
  Toma_De_Datos_grafica_DW.obj_o.isInitialized = 1L;
  digitalIOSetup(13, 1);
  Toma_De_Datos_grafica_DW.obj_o.isSetupComplete = true;
}
...
void Toma_De_Datos_grafica_terminate(void)
{
  ...
  if (!Toma_De_Datos_grafica_DW.obj_k.matlabCodegenIsDeleted) {
    Toma_De_Datos_grafica_DW.obj_k.matlabCodegenIsDeleted = true;
    if ((Toma_De_Datos_grafica_DW.obj_k.isInitialized == 1L) &&
        Toma_De_Datos_grafica_DW.obj_k.isSetupComplete) {
      Toma_De_Datos_grafica_DW.obj_k.PWMDriverObj.MW_PWM_HANDLE =
        MW_PWM_GetHandle(12UL);
      MW_PWM_SetDutyCycle
        (Toma_De_Datos_grafica_DW.obj_k.PWMDriverObj.MW_PWM_HANDLE, 0.0);
      Toma_De_Datos_grafica_DW.obj_k.PWMDriverObj.MW_PWM_HANDLE =
        MW_PWM_GetHandle(12UL);
      MW_PWM_Close(Toma_De_Datos_grafica_DW.obj_k.PWMDriverObj.MW_PWM_HANDLE);
    }
  }
  ...
  if (!Toma_De_Datos_grafica_DW.obj_c.matlabCodegenIsDeleted) {
    Toma_De_Datos_grafica_DW.obj_c.matlabCodegenIsDeleted = true;
    if ((Toma_De_Datos_grafica_DW.obj_c.isInitialized == 1L) &&
        Toma_De_Datos_grafica_DW.obj_c.isSetupComplete) {
      Toma_De_Datos_grafica_DW.obj_c.PWMDriverObj.MW_PWM_HANDLE =
        MW_PWM_GetHandle(9UL);
      MW_PWM_SetDutyCycle
        (Toma_De_Datos_grafica_DW.obj_c.PWMDriverObj.MW_PWM_HANDLE, 0.0);
      Toma_De_Datos_grafica_DW.obj_c.PWMDriverObj.MW_PWM_HANDLE =
        MW_PWM_GetHandle(9UL);
      MW_PWM_Close(Toma_De_Datos_grafica_DW.obj_c.PWMDriverObj.MW_PWM_HANDLE);
    }
  }
  ...
  if (!Toma_De_Datos_grafica_DW.obj_l.matlabCodegenIsDeleted) {
    Toma_De_Datos_grafica_DW.obj_l.matlabCodegenIsDeleted = true;
    if ((Toma_De_Datos_grafica_DW.obj_l.isInitialized == 1L) &&
        Toma_De_Datos_grafica_DW.obj_l.isSetupComplete) {
      Toma_De_Datos_grafica_DW.obj_l.PWMDriverObj.MW_PWM_HANDLE =
        MW_PWM_GetHandle(11UL);
      MW_PWM_SetDutyCycle
        (Toma_De_Datos_grafica_DW.obj_l.PWMDriverObj.MW_PWM_HANDLE, 0.0);
      Toma_De_Datos_grafica_DW.obj_l.PWMDriverObj.MW_PWM_HANDLE =
        MW_PWM_GetHandle(11UL);
      MW_PWM_Close(Toma_De_Datos_grafica_DW.obj_l.PWMDriverObj.MW_PWM_HANDLE);
    }
  }
  ...
  if (!Toma_De_Datos_grafica_DW.obj_m.matlabCodegenIsDeleted) {
    Toma_De_Datos_grafica_DW.obj_m.matlabCodegenIsDeleted = true;
    if ((Toma_De_Datos_grafica_DW.obj_m.isInitialized == 1L) &&
        Toma_De_Datos_grafica_DW.obj_m.isSetupComplete) {
      Toma_De_Datos_grafica_DW.obj_m.PWMDriverObj.MW_PWM_HANDLE =
        MW_PWM_GetHandle(10UL);
      MW_PWM_SetDutyCycle
        (Toma_De_Datos_grafica_DW.obj_m.PWMDriverObj.MW_PWM_HANDLE, 0.0);
      Toma_De_Datos_grafica_DW.obj_m.PWMDriverObj.MW_PWM_HANDLE =
        MW_PWM_GetHandle(10UL);
      MW_PWM_Close(Toma_De_Datos_grafica_DW.obj_m.PWMDriverObj.MW_PWM_HANDLE);
    }
  }
  ...
  if (!Toma_De_Datos_grafica_DW.obj_mx.matlabCodegenIsDeleted) {
    Toma_De_Datos_grafica_DW.obj_mx.matlabCodegenIsDeleted = true;
  }

  /* End of Terminate for MATLABSystem: '<S4>/Digital Output' */

  /* Terminate for MATLABSystem: '<S4>/Digital Output1' */
  if (!Toma_De_Datos_grafica_DW.obj_o.matlabCodegenIsDeleted) {
    Toma_De_Datos_grafica_DW.obj_o.matlabCodegenIsDeleted = true;
  }
