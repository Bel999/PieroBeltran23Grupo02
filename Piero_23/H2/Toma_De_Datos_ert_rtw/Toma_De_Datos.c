...
{
  {
    ...
    /* FromWorkspace: '<S1>/fromWS_Signal 1' */
    {
      ...
      if (t > pTimeValues[10]) {
        ...
        /* Post output */
        {
          ...
          if (t1 == t2) {
            if (t < t1) {
              Toma_De_Datos_B.PWM = pDataValues[currTimeIndex];
            } else {
              Toma_De_Datos_B.PWM = pDataValues[currTimeIndex + 1];
            }
          } else {
            ...
            Toma_De_Datos_B.PWM = (real_T) rtInterpolate(d1, d2, f1, f2);
            pDataValues += 11;
          }
        }
      }
    ...
    if (Toma_De_Datos_DW.obj_p.SampleTime != Toma_De_Datos_P.Encoder_SampleTime)
    {
      Toma_De_Datos_DW.obj_p.SampleTime = Toma_De_Datos_P.Encoder_SampleTime;
    }

    if (Toma_De_Datos_DW.obj_p.TunablePropsChanged) {
      Toma_De_Datos_DW.obj_p.TunablePropsChanged = false;
    }

    MW_EncoderRead(Toma_De_Datos_DW.obj_p.Index, &rtb_Encoder_0);
    ...
    Toma_De_Datos_B.TmpSignalConversionAt_asyncqueu[0] = Toma_De_Datos_B.PWM;
    Toma_De_Datos_B.TmpSignalConversionAt_asyncqueu[1] = Toma_De_Datos_B.PWM;
    ...
    Gain_tmp = floor(Toma_De_Datos_B.PWM);
    ...
    Toma_De_Datos_DW.obj_k.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_GetHandle(12UL);
    ...
    /* MATLABSystem: '<S4>/Adelante_der' */
    MW_PWM_SetDutyCycle(Toma_De_Datos_DW.obj_k.PWMDriverObj.MW_PWM_HANDLE,
                        (real_T)y);

    /* MATLABSystem: '<S4>/Adelante_izq' */
    Toma_De_Datos_DW.obj_c.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_GetHandle(9UL);
    ...
    Toma_De_Datos_DW.obj_l.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_GetHandle(11UL);
    ...
    /* MATLABSystem: '<S4>/Atras_der' */
    MW_PWM_SetDutyCycle(Toma_De_Datos_DW.obj_l.PWMDriverObj.MW_PWM_HANDLE,
                        (real_T)y);

    /* MATLABSystem: '<S4>/Atras_izq' */
    Toma_De_Datos_DW.obj_m.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_GetHandle(10UL);
    ...
    /* MATLABSystem: '<S4>/Atras_izq' */
    MW_PWM_SetDutyCycle(Toma_De_Datos_DW.obj_m.PWMDriverObj.MW_PWM_HANDLE,
                        (real_T)y);
    ...
    writeDigitalPin(13, (uint8_T)(rtb_DataTypeConversion_idx_1 !=
      Toma_De_Datos_P.Constant_Value_h));
  }
...
void Toma_De_Datos_initialize(void)
{
  ...
  /* External mode info */
  Toma_De_Datos_M->Sizes.checksums[0] = (3693888222U);
  Toma_De_Datos_M->Sizes.checksums[1] = (3905306785U);
  Toma_De_Datos_M->Sizes.checksums[2] = (4156145253U);
  Toma_De_Datos_M->Sizes.checksums[3] = (3607506191U);
  ...
  Toma_De_Datos_DW.obj_p.Index = 0U;
  Toma_De_Datos_DW.obj_p.matlabCodegenIsDeleted = false;
  Toma_De_Datos_DW.obj_p.SampleTime = Toma_De_Datos_P.Encoder_SampleTime;
  Toma_De_Datos_DW.obj_p.isInitialized = 1L;
  MW_EncoderSetup(18UL, 19UL, &Toma_De_Datos_DW.obj_p.Index);
  Toma_De_Datos_DW.obj_p.isSetupComplete = true;
  Toma_De_Datos_DW.obj_p.TunablePropsChanged = false;

  /* InitializeConditions for MATLABSystem: '<S3>/Encoder' */
  MW_EncoderReset(Toma_De_Datos_DW.obj_p.Index);
  ...
  /* Start for MATLABSystem: '<S4>/Adelante_der' */
  Toma_De_Datos_DW.obj_k.matlabCodegenIsDeleted = false;
  Toma_De_Datos_DW.obj_k.isInitialized = 1L;
  Toma_De_Datos_DW.obj_k.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_Open(12UL, 0.0, 0.0);
  Toma_De_Datos_DW.obj_k.isSetupComplete = true;

  /* Start for MATLABSystem: '<S4>/Adelante_izq' */
  Toma_De_Datos_DW.obj_c.matlabCodegenIsDeleted = false;
  Toma_De_Datos_DW.obj_c.isInitialized = 1L;
  Toma_De_Datos_DW.obj_c.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_Open(9UL, 0.0, 0.0);
  Toma_De_Datos_DW.obj_c.isSetupComplete = true;

  /* Start for MATLABSystem: '<S4>/Atras_der' */
  Toma_De_Datos_DW.obj_l.matlabCodegenIsDeleted = false;
  Toma_De_Datos_DW.obj_l.isInitialized = 1L;
  Toma_De_Datos_DW.obj_l.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_Open(11UL, 0.0, 0.0);
  Toma_De_Datos_DW.obj_l.isSetupComplete = true;

  /* Start for MATLABSystem: '<S4>/Atras_izq' */
  Toma_De_Datos_DW.obj_m.matlabCodegenIsDeleted = false;
  Toma_De_Datos_DW.obj_m.isInitialized = 1L;
  Toma_De_Datos_DW.obj_m.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_Open(10UL, 0.0, 0.0);
  Toma_De_Datos_DW.obj_m.isSetupComplete = true;

  /* Start for MATLABSystem: '<S4>/Digital Output' */
  Toma_De_Datos_DW.obj_mx.matlabCodegenIsDeleted = false;
  Toma_De_Datos_DW.obj_mx.isInitialized = 1L;
  digitalIOSetup(8, 1);
  Toma_De_Datos_DW.obj_mx.isSetupComplete = true;
...
void Toma_De_Datos_terminate(void)
{
  ...
  if (!Toma_De_Datos_DW.obj_p.matlabCodegenIsDeleted) {
    Toma_De_Datos_DW.obj_p.matlabCodegenIsDeleted = true;
    if ((Toma_De_Datos_DW.obj_p.isInitialized == 1L) &&
        Toma_De_Datos_DW.obj_p.isSetupComplete) {
      MW_EncoderRelease();
    }
  }
  ...
  if (!Toma_De_Datos_DW.obj_k.matlabCodegenIsDeleted) {
    Toma_De_Datos_DW.obj_k.matlabCodegenIsDeleted = true;
    if ((Toma_De_Datos_DW.obj_k.isInitialized == 1L) &&
        Toma_De_Datos_DW.obj_k.isSetupComplete) {
      Toma_De_Datos_DW.obj_k.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_GetHandle(12UL);
      MW_PWM_SetDutyCycle(Toma_De_Datos_DW.obj_k.PWMDriverObj.MW_PWM_HANDLE, 0.0);
      Toma_De_Datos_DW.obj_k.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_GetHandle(12UL);
      MW_PWM_Close(Toma_De_Datos_DW.obj_k.PWMDriverObj.MW_PWM_HANDLE);
    }
  }
  ...
  if (!Toma_De_Datos_DW.obj_l.matlabCodegenIsDeleted) {
    Toma_De_Datos_DW.obj_l.matlabCodegenIsDeleted = true;
    if ((Toma_De_Datos_DW.obj_l.isInitialized == 1L) &&
        Toma_De_Datos_DW.obj_l.isSetupComplete) {
      Toma_De_Datos_DW.obj_l.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_GetHandle(11UL);
      MW_PWM_SetDutyCycle(Toma_De_Datos_DW.obj_l.PWMDriverObj.MW_PWM_HANDLE, 0.0);
      Toma_De_Datos_DW.obj_l.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_GetHandle(11UL);
      MW_PWM_Close(Toma_De_Datos_DW.obj_l.PWMDriverObj.MW_PWM_HANDLE);
    }
  }
  ...
  if (!Toma_De_Datos_DW.obj_m.matlabCodegenIsDeleted) {
    Toma_De_Datos_DW.obj_m.matlabCodegenIsDeleted = true;
    if ((Toma_De_Datos_DW.obj_m.isInitialized == 1L) &&
        Toma_De_Datos_DW.obj_m.isSetupComplete) {
      Toma_De_Datos_DW.obj_m.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_GetHandle(10UL);
      MW_PWM_SetDutyCycle(Toma_De_Datos_DW.obj_m.PWMDriverObj.MW_PWM_HANDLE, 0.0);
      Toma_De_Datos_DW.obj_m.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_GetHandle(10UL);
      MW_PWM_Close(Toma_De_Datos_DW.obj_m.PWMDriverObj.MW_PWM_HANDLE);
    }
  }
  ...
  if (!Toma_De_Datos_DW.obj_mx.matlabCodegenIsDeleted) {
    Toma_De_Datos_DW.obj_mx.matlabCodegenIsDeleted = true;
  }
