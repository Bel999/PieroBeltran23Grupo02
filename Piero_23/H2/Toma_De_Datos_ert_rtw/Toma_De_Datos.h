...
typedef struct {
  ...
  codertarget_arduinobase_int_m_T obj_m;/* '<S4>/Atras_izq' */
  codertarget_arduinobase_int_m_T obj_l;/* '<S4>/Atras_der' */
  codertarget_arduinobase_int_m_T obj_c;/* '<S4>/Adelante_izq' */
  codertarget_arduinobase_int_m_T obj_k;/* '<S4>/Adelante_der' */
