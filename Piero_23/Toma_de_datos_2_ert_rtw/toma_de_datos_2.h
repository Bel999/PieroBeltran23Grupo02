...
#ifndef RTW_HEADER_toma_de_datos_2_h_
#define RTW_HEADER_toma_de_datos_2_h_
#ifndef toma_de_datos_2_COMMON_INCLUDES_
#define toma_de_datos_2_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* toma_de_datos_2_COMMON_INCLUDES_ */

#include "toma_de_datos_2_types.h"
#include <math.h>
...
typedef struct {
  ...
  codertarget_arduinobase_in_al_T obj_m;/* '<S4>/Atras_izq' */
  codertarget_arduinobase_in_al_T obj_l;/* '<S4>/Atras_der' */
  codertarget_arduinobase_in_al_T obj_c;/* '<S4>/Adelante_izq' */
  codertarget_arduinobase_in_al_T obj_k;/* '<S4>/Adelante_der' */
...
} DW_toma_de_datos_2_T;

/* Parameters (default storage) */
struct P_toma_de_datos_2_T_ {
...
struct tag_RTM_toma_de_datos_2_T {
...
extern P_toma_de_datos_2_T toma_de_datos_2_P;

/* Block signals (default storage) */
extern B_toma_de_datos_2_T toma_de_datos_2_B;

/* Block states (default storage) */
extern DW_toma_de_datos_2_T toma_de_datos_2_DW;

/* Model entry point functions */
extern void toma_de_datos_2_initialize(void);
extern void toma_de_datos_2_step(void);
extern void toma_de_datos_2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_toma_de_datos_2_T *const toma_de_datos_2_M;
 ...
 *
 * '<Root>' : 'toma_de_datos_2'
 * '<S1>'   : 'toma_de_datos_2/Signal Editor'
 * '<S2>'   : 'toma_de_datos_2/Subsystem Reference'
 * '<S3>'   : 'toma_de_datos_2/Subsystem Reference/Subsystem Reference'
 * '<S4>'   : 'toma_de_datos_2/Subsystem Reference/Subsystem Reference4'
 * '<S5>'   : 'toma_de_datos_2/Subsystem Reference/Subsystem Reference4/Compare To Zero'
 * '<S6>'   : 'toma_de_datos_2/Subsystem Reference/Subsystem Reference4/Compare To Zero1'
 */
#endif                                 /* RTW_HEADER_toma_de_datos_2_h_ */
