...
#ifndef RTW_HEADER_ControlBA_1_h_
#define RTW_HEADER_ControlBA_1_h_
#ifndef ControlBA_1_COMMON_INCLUDES_
#define ControlBA_1_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* ControlBA_1_COMMON_INCLUDES_ */

#include "ControlBA_1_types.h"
#include <math.h>
...
typedef struct {
  codertarget_arduinobase_int_g_T obj; /* '<S3>/Encoder1' */
  codertarget_arduinobase_int_g_T obj_p;/* '<S3>/Encoder' */
  codertarget_arduinobase_inter_T obj_n;/* '<Root>/Analog Input' */
  codertarget_arduinobase_in_gu_T obj_m;/* '<S4>/Atras_izq' */
  codertarget_arduinobase_in_gu_T obj_l;/* '<S4>/Atras_der' */
  codertarget_arduinobase_in_gu_T obj_c;/* '<S4>/Adelante_izq' */
  codertarget_arduinobase_in_gu_T obj_k;/* '<S4>/Adelante_der' */
...
extern P_ControlBA_1_T ControlBA_1_P;

/* Block signals (default storage) */
extern B_ControlBA_1_T ControlBA_1_B;

/* Block states (default storage) */
extern DW_ControlBA_1_T ControlBA_1_DW;

/* Model entry point functions */
extern void ControlBA_1_initialize(void);
extern void ControlBA_1_step(void);
extern void ControlBA_1_terminate(void);

/* Real-time Model object */
extern RT_MODEL_ControlBA_1_T *const ControlBA_1_M;
 ...
 *
 * '<Root>' : 'ControlBA_1'
 * '<S1>'   : 'ControlBA_1/Signal Editor'
 * '<S2>'   : 'ControlBA_1/Subsystem Reference'
 * '<S3>'   : 'ControlBA_1/Subsystem Reference/Subsystem Reference'
 * '<S4>'   : 'ControlBA_1/Subsystem Reference/Subsystem Reference4'
 * '<S5>'   : 'ControlBA_1/Subsystem Reference/Subsystem Reference4/Compare To Zero'
 * '<S6>'   : 'ControlBA_1/Subsystem Reference/Subsystem Reference4/Compare To Zero1'
 */
#endif                                 /* RTW_HEADER_ControlBA_1_h_ */
