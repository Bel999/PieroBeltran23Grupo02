###########################################################################
## Makefile generated for component 'Primera_Parte_Hito2_Siganl_PWM'. 
## 
## Makefile     : Primera_Parte_Hito2_Siganl_PWM.mk
## Generated on : Wed Nov 15 01:02:42 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Primera_Parte_Hito2_Siganl_PWM.elf
...
PRODUCT_NAME              = Primera_Parte_Hito2_Siganl_PWM
MAKEFILE                  = Primera_Parte_Hito2_Siganl_PWM.mk
MATLAB_ROOT               = D:/Matlab23
MATLAB_BIN                = D:/Matlab23/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/MATLAB/Piero_23/ControlBA_1_ert_rtw
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Primera_Parte_Hito2_Siganl_PWM.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(MATLAB_ROOT)/toolbox/target/shared/svd/common/include -I$(START_DIR)/Primera_Parte_Hito2_Siganl_PWM_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr
...
DEFINES_STANDARD = -DMODEL=Primera_Parte_Hito2_Siganl_PWM -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/Primera_Parte_Hito2_Siganl_PWM_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Primera_Parte_Hito2_Siganl_PWM_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Primera_Parte_Hito2_Siganl_PWM_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Primera_Parte_Hito2_Siganl_PWM.o : $(START_DIR)/Primera_Parte_Hito2_Siganl_PWM_ert_rtw/Primera_Parte_Hito2_Siganl_PWM.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Primera_Parte_Hito2_Siganl_PWM_data.o : $(START_DIR)/Primera_Parte_Hito2_Siganl_PWM_ert_rtw/Primera_Parte_Hito2_Siganl_PWM_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Primera_Parte_Hito2_Siganl_PWM_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Primera_Parte_Hito2_Siganl_PWM_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Primera_Parte_Hito2_Siganl_PWM_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Primera_Parte_Hito2_Siganl_PWM_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
