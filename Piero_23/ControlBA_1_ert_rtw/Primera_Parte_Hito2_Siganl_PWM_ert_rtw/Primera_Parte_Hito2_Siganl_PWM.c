...
{
  {
    ...
    /* MATLABSystem: '<S3>/Encoder' */
    MW_EncoderRead(Primera_Parte_Hito2_Siganl_P_DW.obj_p.Index,
                   &Primera_Parte_Hito2_Siganl_PW_B.Encoder);
    ...
    /* MATLABSystem: '<S3>/Encoder1' */
    MW_EncoderRead(Primera_Parte_Hito2_Siganl_P_DW.obj.Index,
                   &Primera_Parte_Hito2_Siganl_PW_B.Encoder1);
     ...
     */
    Primera_Parte_Hito2_Siganl_PW_B.Gain[0] = Gain_tmp * (real_T)
      Primera_Parte_Hito2_Siganl_PW_B.Encoder;
    Primera_Parte_Hito2_Siganl_PW_B.Gain[1] = Gain_tmp * (real_T)
      Primera_Parte_Hito2_Siganl_PW_B.Encoder1;
    ...
    Gain_tmp = floor(Primera_Parte_Hito2_Siganl_PW_B.Signal1);
    ...
    Primera_Parte_Hito2_Siganl_PW_B.TmpSignalConversionAtTAQSigLogg[0] =
      Primera_Parte_Hito2_Siganl_PW_B.Encoder;
    Primera_Parte_Hito2_Siganl_PW_B.TmpSignalConversionAtTAQSigLogg[1] =
      Primera_Parte_Hito2_Siganl_PW_B.Encoder1;
...
void Primera_Parte_Hito2_Siganl_PWM_initialize(void)
{
  ...
  Primera_Parte_Hito2_Siganl_P_M->Timing.stepSize0 = 0.2;

  /* External mode info */
  Primera_Parte_Hito2_Siganl_P_M->Sizes.checksums[0] = (1161406874U);
  Primera_Parte_Hito2_Siganl_P_M->Sizes.checksums[1] = (370618154U);
  Primera_Parte_Hito2_Siganl_P_M->Sizes.checksums[2] = (3615640820U);
  Primera_Parte_Hito2_Siganl_P_M->Sizes.checksums[3] = (3020186678U);
