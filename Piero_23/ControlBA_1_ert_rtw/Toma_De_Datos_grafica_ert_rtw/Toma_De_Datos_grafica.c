 ...
 * C/C++ source code generated on : Tue Nov 14 23:54:21 2023
 *
...
{
  {
    ...
    /* MATLABSystem: '<S3>/Encoder' */
    MW_EncoderRead(Toma_De_Datos_grafica_DW.obj_p.Index,
...
void Toma_De_Datos_grafica_initialize(void)
{
  ...
  /* External mode info */
  Toma_De_Datos_grafica_M->Sizes.checksums[0] = (2027164272U);
  Toma_De_Datos_grafica_M->Sizes.checksums[1] = (4033792936U);
  Toma_De_Datos_grafica_M->Sizes.checksums[2] = (678490321U);
  Toma_De_Datos_grafica_M->Sizes.checksums[3] = (3475534667U);
