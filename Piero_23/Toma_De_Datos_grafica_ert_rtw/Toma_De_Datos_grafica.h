...
typedef struct {
  ...
  codertarget_arduinobase_inter_T obj_n;/* '<S3>/Encoder' */
  codertarget_arduinobase_int_j_T obj_p;/* '<S4>/Atras_izq' */
  codertarget_arduinobase_int_j_T obj_g;/* '<S4>/Atras_der' */
  codertarget_arduinobase_int_j_T obj_pv;/* '<S4>/Adelante_izq' */
  codertarget_arduinobase_int_j_T obj_d;/* '<S4>/Adelante_der' */
  codertarget_arduinobase_block_T obj_j;/* '<S4>/Digital Output1' */
  codertarget_arduinobase_block_T obj_g1;/* '<S4>/Digital Output' */
